...
#knot positions
optim.knots.3knot=quantile(log(t[d==1]),c(seq(0,1-1/4,1/4),1))
optim.myknots=optim.knots.3knot #I rename here just to save myself some copy and pasting in the loglik function below. 

maxknot=5 #total number of knots (including boundary knots)
...
optim.fit.3knot=optim(flexmod.3knot$coefficients,loglik,method="BFGS",hessian=F)

myhess.3knot=fdHess(flexmod.3knot$coefficients,loglik)

varcov.myhess.3knot=solve(myhess.3knot$Hessian)
