...
save(flexmod.aic,file="./sim_results/flexmod_aic_scenario4.RData")
save(optim.aic,file="./sim_results/optim_aic_scenario4.RData")

save(flexmod.knots,file="./sim_results/flexmod_knots_scenario4.RData")
save(optim.knots,file="./sim_results/optim_knots_scenario4.RData")

save(flexmod.params,file="./sim_results/flexmod_params_scenario4.RData")
save(optim.params,file="./sim_results/optim_params_scenario4.RData")

save(flexmod.varcov,file="./sim_results/flexmod_varcov_scenario4.RData")
save(optim.varcov,file="./sim_results/optim_varcov_scenario4.RData")
